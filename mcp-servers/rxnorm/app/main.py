"""
RxNorm MCP Server — Application Entry Point
===============================================
...
logger = logging.getLogger("mcp.rxnorm")
...
async def lifespan(app: FastAPI):
    ...
    logger.info(
        "Starting RxNorm MCP Server v%s on %s:%s",
    ...
    yield
    logger.info("Shutting down RxNorm MCP Server")
...
app = FastAPI(
    title="RxNorm MCP Server",
    description=(
        "PIKRS MCP server for RxNorm.  Normalizes drug names and retrieves "
        "RxCUIs, ingredients, synonyms, and brand names."
    ),
