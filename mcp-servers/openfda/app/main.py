"""
OpenFDA MCP Server — Application Entry Point
===============================================
...
logger = logging.getLogger("mcp.openfda")
...
async def lifespan(app: FastAPI):
    ...
    logger.info(
        "Starting OpenFDA MCP Server v%s on %s:%s",
    ...
    yield
    logger.info("Shutting down OpenFDA MCP Server")
...
app = FastAPI(
    ...
    description=(
        "PIKRS MCP server for OpenFDA. Retrieves regulatory and safety "
        "information about drugs including indications, dosage, and warnings."
    ),
